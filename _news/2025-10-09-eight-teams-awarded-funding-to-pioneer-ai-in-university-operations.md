...
“This next generation of AI offers the potential to develop digital systems that adapt to us, that solve the problems we have. The best way to do that is to work closely with staff the staff that deal with those issues on a day-to-day basis. AI for University Operations is about empowering colleagues to experiment responsibly and learn what works,” said Professor Neil Lawrence, Chair of ai@cam. “These projects show that when AI is applied to the real challenges our colleagues face, it can enhance efficiency and decision-making, allowing people to focus on the most meaningful parts of their roles.”
