...
The project, called PRISM (Predictive Risk Intelligence for Social housing Maintenance), is a collaboration between the University of Cambridge and two local councils: Cambridge City Council and South Cambridgeshire District Council. It is supported by the [Local Government AI Accelerator](https://www.ai.cam.ac.uk/news/cambridge-launches-ai-accelerator-to-help-local-government-deploy-ai/), a new initiative from ai@cam, the University’s flagship mission on artificial intelligence.
...
[Read the full story ](https://www.cam.ac.uk/research/news/ai-system-could-predict-safety-problems-in-social-housing-before-they-happen)
