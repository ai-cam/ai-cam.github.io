...
call_date: 2025-08-29
application_deadline: 2025-08-29
call_content: >-
  ...
  more efficient administrative processes while freeing up time for complex work
  requiring judgment, creativity, and human collaboration. ai@cam’s AI for
  Operations programme aims to support this shift, enabling improved student and
  researcher experiences through streamlined and responsive administrative
  systems.
...
apply_text: >-
  ...
  **13.30–15.30 | Wednesday 13 May - Show & Tell Final showcase**
  ...
  If you have any questions about the call, please email Annabelle Scott ([as599@cam.ac.uk](https://www.ai.cam.ac.uk/calls/ai-for-university-operations-project-funding-call)). Further information can be found below in our FAQs.
apply_links:
  - link: forms.gle/kKvRo57cmdA95z1u5
    link_text: Apply here
faq_title: F.A.Q.
faqs:
  - question: What are the objectives of the AI for operations programme?
    answer: The AI for Operations programme enables professional services teams to
  ...
  - question: Who is eligible to apply?
    answer: Professional services staff teams employed by the University of
      Cambridge are eligible to apply for this funding. Academic and
      academic-related staff are also eligible to apply, however, we expect all
      teams to include professional services staff.
  - question: What information is required in the application form?
    answer: >-
  ...
  - answer: |-
      ...
      * Approach to risk management and ethical considerations
    question: How will the project proposal be evaluated?
  - answer: Small grants of up to £10,000 will be available, depending on scope and
      ...
      resources for data collection. They are not intended to cover staff time.
    question: How much funding is available per project?
  - answer: >-
      **Funding:** Grants of up to £10,000 each will be awarded to project teams
      to cover implementation costs such as software subscriptions and resources
      for data collection (not staff time).
    ...
    question: What support will grant awardees recieve?
  - answer: We will notify candidates in the week commencing 6 October if their
      project has been selected for funding.
    question: When will I find out if my project has been awarded funding?
  - answer: Yes. If you are awarded funding we expect your line manager to give
      their support for you to undertake the project proposed.
    question: Do I need approval from my line manager?
  ...
  - answer: This depends on your project’s scope and team size. Project members are
      expected to attend our launch workshop on 7 October 2025 and a showcase
      event at the project’s conclusion. All projects will need to be completed
      within 6 months of the project start date.
    question: What would the time commitment be for conducting a project?
  ...
  - answer: We encourage you to create cross-disciplinary teams, they can be made up
      of staff from different departments. We recommend that teams have no more
      than 10 members of staff.
    question: Are there any restrictions on the team makeup, for example are there a
      maximum number of staff that can be in a team, can it be made up of staff
  ...
  - answer: >-
      ...
      have already flagged potential applications of AI in the following areas:
    ...
    question: What kind of administrative challenges are covered under the scope of
      the funding?
  - answer: We will ask successful projects to share their implementations in a
  ...
  - answer: >-
      ...
      when handling sensitive data. We’re committed to embedding responsible AI
      principles throughout the University, and the programme will encourage
      ongoing critical reflection as projects develop. Current university
      guidance on AI in relation to information compliance, communications, and
  ...
  - answer: >-
      Please fill in the application form above by 12:00 Friday 29 August 2025.
      You will need to be logged in to your @cam.ac.uk account to access the
      form.
