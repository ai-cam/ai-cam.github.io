...
call_content: >-
  AI is changing the context in which teaching and learning happen. Students and
  academics have access to tools that can generate text, code and ideas, explain
  concepts and support their work. These capabilities create opportunities to
  improve education, but also challenge assumptions built into existing
  ...
  We are inviting applications until end of day (23:59) on Thursday 24 September 2026 via [this link](<https://forms.gle/TsZBaU7yojSFxoaj7  >). Further information is below.
...
faqs:
  ...
  - question: How will projects be assessed?
    answer: >-
      ...
      * the importance of the question to teaching and learning at Cambridge;

      * the quality of the proposed approach to investigating it;

      * attention to relevant risks, including academic integrity, fairness between students, data protection, and the relationship with students;

      * deliverability within the six-month timeframe; and

      * how useful the resulting insight is likely to be to other colleagues.
  - question: What do I need to submit to apply?
    answer: >-
      ...
      * What you propose to develop and test in your teaching, course or educational practice.

      * What you hope to learn and how you will understand what happened.

      * Who will be involved or affected, including how students or other educators will be involved where relevant.

      * What others at Cambridge could learn from or use from your project.

      * What you will need to deliver the work.
