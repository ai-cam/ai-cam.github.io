...
call_content: >-
  ...
  education. Too many potentially game-changing ideas never move beyond academic
  papers, when they could be benefitting people and society.
...
apply_text: >-
  ...
  find out more about the programme sprint. Make sure to register for the info
  session here.

  2. Apply to the AI-deas sprint programme call here. The deadline for applications is 17.00, Friday 10 October.

  3. We’ll be evaluating project teams at a pitch presentation session on Wednesday 29 October. Please register to confirm you can join the pitch presentation session in the programme call application form.
...
faqs:
  ...
  - question: Who is eligible to apply?
    answer: This call is open to research staff at the University of Cambridge,
      working in any discipline, including natural, physical, biological,
      social, medical, and computer sciences, arts, humanities, and engineering,
      and the University’s collections community. We’re looking for projects
      that build on our existing portfolio, and for applications to think about
      how they have engaged with our existing programmes or how they might
      enhance them.
  - question: What information is required in the application form?
    answer: >-
      ...
      * A 2-page proposal on your project idea that sets out:
      ...
      1. the problem you hope to address;
         the proposed solution;
      2. the deliverables that would need to be met over six months to deliver a minimum viable project

      3. how you have linked with existing ai@cam programmes or how their work will enhance those programmes. 
  ...
  - answer: Applications will be evaluated based on innovation, real-world impact
      ...
      session in the [application form.](forms.gle/Zbc2NVKXxY4T66DA8)
    question: How will the application be evaluated?
  - answer: If you or a member of your team aren’t able to be present at the pitch
      session in person on Wednesday 29 October, please get in touch with
      Annabelle Scott (as599@cam.ac.uk).
    question: What if I can't make the pitch presentation session?
  - answer: Up to £25,000 is available for a duration of 6 months. The funding can
    ...
    question: How much funding is available per AI-deas sprint project and what will
      the funding cover?
  - answer: AI-deas sprint projects will receive access to technical support from
      machine learning engineers and opportunities to engage and develop
      external partnerships.
    question: What support will AI-deas sprint projects recieve?
  - answer: Teams that have been selected for funding will be announced at the end
      of October.
  ...
  - answer: Yes, please provide a brief summary in the application form of what you
      ...
      6-month time period.
    question: Do we need to submit costing breakdown?
  - answer: We encourage you to create cross-disciplinary teams, they can be made up
      of researchers from different departments. We recommend that teams are
      made up of no more than 6 researchers.
  ...
  - answer: >-
    ...
    question: What topics are covered under the scope of funding?
  ...
  - answer: >-
      ...
      form](https://docs.google.com/forms/d/e/1FAIpQLSfLalGzIz4xBQr2xR4WDyrq9-1ro6HpLlzzOfO41rRlfzN3lg/viewform?usp=send_form)
      here by 17:00, Friday 10 October 2025. You will need to be logged in to
      your @cam.ac.uk account to access the form.
