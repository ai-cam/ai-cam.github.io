...
apply_links:
  - link: forms.gle/GKN5DnmLfyf5ru3X9
    link_text: Apply here
faq_title: F.A.Q.
faqs:
  - question: What makes this a "reverse" poster session?
    answer: Unlike traditional academic conferences where researchers present their
  ...
  - question: What types of challenges should councils present?
    answer: Any public service challenge where AI might help - from reducing social
  ...
  - question: Who can attend?
    answer: Local council staff from Cambridgeshire, Peterborough, and Greater
  ...
  - answer: University - council partnerships will be eligible for dedicated funding
      in our second phase to develop proof-of-concept solutions. We’ll provide
      structured follow-up to help promising collaborations move forward.
    question: What happens if I find a potential collaborator?
  - answer: Not at all. We want people who understand the real operational
      challenges councils face.
    question: Do I need to be technical to participate as a council staff member?
  - answer: |-
    ...
    question: What should my poster include?
  - answer: 4 hours (12:00-16:00) including lunch and refreshments. This gives time
      for meaningful conversations rather than rushed presentations.
    question: How long is the poster session?
  - answer: Later this year, ai@cam will be launching its AI for Local Government
      Accelerator, which will invite applications for funding and
      incubator-style support for collaborative projects between the University
      and local government.
    question: What happens after the session?
  - answer: While we welcome poster presentations from all participating councils,
      ...
      participating regions, and we anticipate that all funding proposals should
      include at least one council partner. Full guidance on this will be
      published after the poster session.
    question: Who will be eligible for follow up funding?
  - answer: The session itself provides valuable networking and learning
    ...
    question: What if my idea doesn't lead to a collaboration?
  - answer: If you’re dealing with large volumes of data, repetitive tasks, pattern
      recognition needs, or complex decision support - AI might help.
    question: How do I know if my challenge is suitable for AI?
  - answer: Absolutely. We encourage this where it makes sense - shared challenges
      often lead to more impactful and sustainable solutions.
    question: Can multiple councils work on the same challenge?
  - answer: >-
    ...
    question: How do I create the poster?
  - answer: >-
      Complete the registration form [here](forms.gle/DZx8ogsHmf1Bejrd8) by
      Friday 14 November.
