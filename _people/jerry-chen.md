...
institute: Isaac Newton Trust Academic Career Development Fellow
...
biography: >-
  ...
  interested in the relationship between the built environment and subjective
  wellbeing. Using a quasi-experimental approach to establish and quantify the
  causal pathways, Jerry applies a combination of econometrics and machine
  learning methods. An example of what he seeks to answer is “All else equal,
  does moving from the city centre to the countryside make one happier?”. He
  also studies how remote working impacts the spatial and temporal organisation
  of cities, and its implications on workers’ subjective wellbeing.
